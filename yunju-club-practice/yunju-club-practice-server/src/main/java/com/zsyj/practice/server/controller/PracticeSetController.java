...
public class PracticeSetController {
    ...
    public Result<PracticeSetVO> addPractice(@RequestBody GetPracticeSubjectListReq req) {
        ...
        try {
            ...
            Preconditions.checkArgument(!CollectionUtils.isEmpty(req.getAssembleIds()), "组合标签ids不能为空！");
            ...
            return Result.fail("开始练习异常！");
        }
    }


    /**
     * 获取练习题（根据套题ID获取新练习题ID等信息||根据套题和练习ID获取未完成的练习信息）
     */
    ...
    /**
     * 获取题目详情（根据套题里面的练习题信息 题目id、题目类型 获取题目详情）
     */
