...
import com.zsyj.circle.server.dao.ShareCommentReplyMapper;
import com.zsyj.circle.server.dao.ShareMomentMapper;
...
import com.zsyj.circle.server.rpc.AuthUserServiceRpc;
import com.zsyj.circle.server.service.ShareCommentReplyService;
import com.zsyj.circle.server.util.LoginUtil;
import com.zsyj.circle.server.util.TreeUtils;
...
public class ShareCommentReplyServiceImpl extends ServiceImpl<ShareCommentReplyMapper, ShareCommentReply> implements ShareCommentReplyService {
    ...
    public List<ShareCommentReplyVO> listComment(GetShareCommentReq req) {
        ...
        Map<String, UserInfo> userInfoMap = authUserServiceRpc.batchGetUserInfo(userNameList);
